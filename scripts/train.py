...
from notate.training import get_metric, get_optimizer, get_scheduler, get_process, AlarmHook, hook_type2class, get_hook
...
def main(config, args=None):
    ...
    train_processes = [get_process(**process) for process in trconfig.train_loop]    # Prepare abortion
    ...
    # Local hook definitions that need access to runtime variables
